...
const Contacts = () => {
  ...
  const columns = [
    ...
    { field: "addressLine", headerName: "Address", flex: 1 },
  ...
  return (
    <Box m="20px">
      ...
      >
        <DataGrid rows={clients} columns={columns} components={{ Toolbar: CustomToolbar }} />
      </Box>
    </Box>
  );
};
...
const CustomToolbar = () => {
  return (
    <GridToolbar filterButton exportOptions />
  );
};
